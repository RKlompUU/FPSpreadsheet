...
previewFrameCreate preview parent title xywidthheight style name 
  = withObjectResult $
    withObjectPtr preview $ \cobj_preview -> 
    withObjectPtr parent $ \cobj_parent -> 
    withStringPtr title $ \cobj_title -> 
    withStringPtr name $ \cobj_name -> 
    wxPreviewFrame_Create cobj_preview  cobj_parent  cobj_title  (toCIntRectX xywidthheight) (toCIntRectY xywidthheight)(toCIntRectW xywidthheight) (toCIntRectH xywidthheight)  (toCInt style)  cobj_name  
...
-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_ALLOW_DND@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_ALLOW_DND #-}
wxEVT_COMMAND_AUINOTEBOOK_ALLOW_DND ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_ALLOW_DND 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_ALLOW_DND 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_ALLOW_DND" wx_expEVT_COMMAND_AUINOTEBOOK_ALLOW_DND :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG #-}
wxEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG" wx_expEVT_COMMAND_AUINOTEBOOK_BEGIN_DRAG :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_BG_DCLICK@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_BG_DCLICK #-}
wxEVT_COMMAND_AUINOTEBOOK_BG_DCLICK ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_BG_DCLICK 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_BG_DCLICK 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_BG_DCLICK" wx_expEVT_COMMAND_AUINOTEBOOK_BG_DCLICK :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_BUTTON@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_BUTTON #-}
wxEVT_COMMAND_AUINOTEBOOK_BUTTON ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_BUTTON 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_BUTTON 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_BUTTON" wx_expEVT_COMMAND_AUINOTEBOOK_BUTTON :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_DRAG_DONE@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_DRAG_DONE #-}
wxEVT_COMMAND_AUINOTEBOOK_DRAG_DONE ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_DRAG_DONE 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_DRAG_DONE 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_DRAG_DONE" wx_expEVT_COMMAND_AUINOTEBOOK_DRAG_DONE :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION #-}
wxEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION" wx_expEVT_COMMAND_AUINOTEBOOK_DRAG_MOTION :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_END_DRAG@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_END_DRAG #-}
wxEVT_COMMAND_AUINOTEBOOK_END_DRAG ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_END_DRAG 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_END_DRAG 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_END_DRAG" wx_expEVT_COMMAND_AUINOTEBOOK_END_DRAG :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED #-}
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED" wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGED :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING #-}
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING" wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CHANGING :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE #-}
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE" wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSE :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED #-}
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED" wx_expEVT_COMMAND_AUINOTEBOOK_PAGE_CLOSED :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN #-}
wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN" wx_expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_DOWN :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP #-}
wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP" wx_expEVT_COMMAND_AUINOTEBOOK_TAB_MIDDLE_UP :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN #-}
wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN" wx_expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_DOWN :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP@).
{-# NOINLINE wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP #-}
wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP ::  EventId
wxEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP 
foreign import ccall "expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP" wx_expEVT_COMMAND_AUINOTEBOOK_TAB_RIGHT_UP :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG@).
{-# NOINLINE wxEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG #-}
wxEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG ::  EventId
wxEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG 
foreign import ccall "expEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG" wx_expEVT_COMMAND_AUITOOLBAR_BEGIN_DRAG :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK@).
{-# NOINLINE wxEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK #-}
wxEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK ::  EventId
wxEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK 
foreign import ccall "expEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK" wx_expEVT_COMMAND_AUITOOLBAR_MIDDLE_CLICK :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK@).
{-# NOINLINE wxEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK #-}
wxEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK ::  EventId
wxEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK 
foreign import ccall "expEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK" wx_expEVT_COMMAND_AUITOOLBAR_OVERFLOW_CLICK :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK@).
{-# NOINLINE wxEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK #-}
wxEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK ::  EventId
wxEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK 
foreign import ccall "expEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK" wx_expEVT_COMMAND_AUITOOLBAR_RIGHT_CLICK :: IO CInt

-- | usage: (@wxEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN@).
{-# NOINLINE wxEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN #-}
wxEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN ::  EventId
wxEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN 
  = unsafePerformIO $
    withIntResult $
    wx_expEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN 
foreign import ccall "expEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN" wx_expEVT_COMMAND_AUITOOLBAR_TOOL_DROPDOWN :: IO CInt
