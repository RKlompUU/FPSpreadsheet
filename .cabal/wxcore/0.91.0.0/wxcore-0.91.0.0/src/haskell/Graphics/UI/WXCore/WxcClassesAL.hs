...
glCanvasCreate parent windowID attributes xywh style title palette 
  = withObjectResult $
    withObjectPtr parent $ \cobj_parent -> 
    withStringPtr title $ \cobj_title -> 
    withObjectPtr palette $ \cobj_palette -> 
    wxGLCanvas_Create cobj_parent  (toCInt windowID)  attributes  (toCIntRectX xywh) (toCIntRectY xywh)(toCIntRectW xywh) (toCIntRectH xywh)  (toCInt style)  cobj_title  cobj_palette  
...
foreign import ccall "wxGraphicsPath_Create" wxGraphicsPath_Create :: IO (Ptr (TGraphicsPath ()))
