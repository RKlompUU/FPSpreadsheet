...
/* package fingertree-0.1.0.2 */
#define VERSION_fingertree "0.1.0.2"
#define MIN_VERSION_fingertree(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)

/* package semigroups-0.8.5 */
#define VERSION_semigroups "0.8.5"
...
#define CURRENT_PACKAGE_KEY "grape_13JTGZXnlHQFaUK6U5sie4"
